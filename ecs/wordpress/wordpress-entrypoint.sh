...
COMMENT
    ...
    sed -i '317s;"";"espnplus-top.min.js", "espnplus-bottom.min.js";g' /var/www/html/wp-content/w3tc-config/master.php
    sed -i '320s;"";"espnplus-critical.min.css", "espnplus-non-critical.min.css", "style.css";g'  /var/www/html/wp-content/w3tc-config/master.php
