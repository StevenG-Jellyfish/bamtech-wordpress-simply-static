...
const jsVersion = 20180530005; // increment to bust cache on css and js.
    ...
    src: {
        ...
        vendor: {
           ...
           // popper: '_vendor/js/popper.js',
            ...
            lazy: '_vendor/js/jquery.lazy.js',
            lazyplugin: '_vendor/js/jquery.lazy.plugins.js',
            // lazy: '_vendor/js/lazysizes.js',
