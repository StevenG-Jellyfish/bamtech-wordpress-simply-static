 ...
 WHERE taxonomy=%s AND name=%s AND parent=$parent AND $wpdb->terms.term_id=$wpdb->term_taxonomy.term_id",
    ...
    public function viewFolderOptions()
    {
        if (isset($_POST['btn_wpmf_save'])) {
            ...
            // update load gif option
            if (isset($_POST['load_gif'])) {
                wpmfSetOption('load_gif', $_POST['load_gif']);
            }

            // update watermark margin option
            if (isset($_POST['watermark_margin'])) {
                wpmfSetOption('watermark_margin', $_POST['watermark_margin']);
            }

            // update watermark image scaling
            if (isset($_POST['watermark_image_scaling'])) {
                wpmfSetOption('watermark_image_scaling', $_POST['watermark_image_scaling']);
            }
