...
<div class="content-box content-wpmf-files-folders">
    ...
    <div class="cboption">
        <div class="wpmf_row_full">
            ...
            <label data-alt="<?php _e('Load GIF file on page load', 'wpmf') ?>"
                   class="text"><?php _e('Load GIF file on page load', 'wpmf') ?>
            </label>
            <div class="switch-optimization">
                <label class="switch switch-optimization">
                    <input type="checkbox" name="load_gif" value="1"
                        <?php
                        if (isset($load_gif) && $load_gif == 1) {
                            echo 'checked';
                        }
                        ?>
                    >
    ...
    <div class="cboption">
        <div class="wpmf_row_full">
            <label data-alt="<?php _e('Select a picture that will be applied over your images', 'wpmf') ?>" class="text">
    ...
    <div class="cboption">
        <div class="wpmf_row_full">
            <label data-alt="<?php _e('Select the watermark image position', 'wpmf'); ?>" class="text">
    ...
    <div class="cboption">
        <div class="wpmf_row_full">
            <label data-alt="<?php _e('Make a watermark fit each photo size, resize the width of the watermark', 'wpmf'); ?>" class="text">
                <?php _e('Image scaling', 'wpmf') ?>
            </label>
                ...
                <div>
                    <label>
                        <input type="number" class="small-text"
                               ...
                               value="<?php echo $watermark_image_scaling ?>">
                    </label>
                    <label><?php _e('%', 'wpmf') ?></label>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="cboption">
        <div class="wpmf_row_full">
            <label data-alt="<?php _e('Watermark image margin', 'wpmf'); ?>" class="text">
                <?php _e('Image margin', 'wpmf') ?>
            </label>
            <div class="wrap_apply">
                <div>
                    <label class="wtm-label-small-text"><?php _e('Top', 'wpmf') ?></label>
                    <label>
                        <input type="number" class="small-text"
                               name="watermark_margin[top]"
                               value="<?php echo $watermark_margin['top'] ?>">
                    </label>
                    <label><?php _e('px', 'wpmf') ?></label>
                </div>
                <div>
                    <label class="wtm-label-small-text"><?php _e('Right', 'wpmf') ?></label>
                    <label>
                        <input type="number" class="small-text"
                               name="watermark_margin[right]"
                               value="<?php echo $watermark_margin['right'] ?>">
                    </label>
                    <label><?php _e('px', 'wpmf') ?></label>
                </div>
                <div>
                    <label class="wtm-label-small-text"><?php _e('Bottom', 'wpmf') ?></label>
                    <label>
                        <input type="number" class="small-text"
                               name="watermark_margin[bottom]"
                               value="<?php echo $watermark_margin['bottom'] ?>">
                    </label>
                    <label><?php _e('px', 'wpmf') ?></label>
                </div>
                <div>
                    <label class="wtm-label-small-text"><?php _e('Left', 'wpmf') ?></label>
                    <label>
                        <input type="number" class="small-text"
                               name="watermark_margin[left]"
                               value="<?php echo $watermark_margin['left'] ?>">
                    </label>
                    <label><?php _e('px', 'wpmf') ?></label>
                </div>
            </div>
    ...
    <div class="cboption">
        <div class="wpmf_row_full">
            <label data-alt="<?php _e('Select the size where you want to apply the watermark', 'wpmf'); ?>"
    ...
    <div class="cboption">
        <div class="wpmf_row_full">
            ...
            <div class="button wpmf_watermark_regeneration"
                 ><?php _e('Thumbnail regeneration', 'wpmf') ?></div>
