...
function html5blank_styles()
{
    ...
    wp_register_style( 'bootstrap', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css', array(), '1.1', 'all');
    wp_enqueue_style('bootstrap'); // Enqueue it!

    wp_register_style( 'bootstraptheme', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css', array(), '1.1', 'all');
